...
const navItems = [
  ...
  },
  {
    path: '/verifikasi',
    label: 'Laporan Masuk',
    icon: '<svg viewBox="0 0 20 20" width="20" height="20" fill="currentColor"><path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z"/></svg>',
  },
  {
    path: '/data-cpmi',
    label: 'Data CPMI',
  ...
  },
  {
    ...
    icon: '<svg viewBox="0 0 20 20" width="20" height="20" fill="currentColor"><path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 7.707 7.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>',
  },
  {
    path: '/perusahaan',
    label: 'Perusahaan',
  ...
  <div class="layout">
    <aside class="sidebar" :class="{ open: sidebarOpen }">
      ...
      <nav class="sidebar-nav">
        <div class="nav-label-group">Menu Admin</div>
        <router-link
      ...
      <div class="sidebar-footer">
        <div class="user-card">
          ...
          <div class="user-info">
            ...
            <p class="user-role">{{ auth.isAdmin ? 'Administrator' : 'User' }}</p>
          </div>
        </div>
